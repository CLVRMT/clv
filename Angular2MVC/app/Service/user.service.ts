...
export class UserService {
    ...
    post(url: string, action: string, model: any): Observable<any> {
    ...
    put(url: string, id: number, action: string, model: any): Observable<any> {
        let body = JSON.stringify(model);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
    ...
    delete(url: string, id: number, action: string): Observable<any> {
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
